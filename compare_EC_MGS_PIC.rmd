...
```{r}
#At time 0
cor_C_0 = cor(t(dif_C_0[overlapping_EC,]),t(P2_dif_C_0[overlapping_EC,]), method = "spearman")
corr_C_0 = cor.test(t(dif_C_0[overlapping_EC,]),t(P2_dif_C_0[overlapping_EC,]), method = "spearman")
...
plot_C_0 = ggplot(diag_cor_C_0, aes(x = diag_cor_C_0, y = EC_class, group = EC_class)) +
  ...
  ylab("EC class")
#At time 51
cor_C_51 = cor(t(dif_C_51[overlapping_EC,]),t(P2_dif_C_51[overlapping_EC,]), method = "spearman")
corr_C_51 = cor.test(t(dif_C_51[overlapping_EC,]),t(P2_dif_C_51[overlapping_EC,]), method = "spearman")
...
plot_C_51 = ggplot(diag_cor_C_51, aes(x = diag_cor_C_51, y = EC_class, group = EC_class)) +
  ...
  ylab("EC class")
#At time 125
cor_C_125 = cor(t(dif_C_125[overlapping_EC,]),t(P2_dif_C_125[overlapping_EC,]), method = "spearman")
corr_C_125 = cor.test(t(dif_C_125[overlapping_EC,]),t(P2_dif_C_125[overlapping_EC,]), method = "spearman")
