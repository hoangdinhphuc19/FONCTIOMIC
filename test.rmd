...
```{r}
DA_COG_Crop = unique(intersect(DA_COG_MGS_Crop$COG,DA_COG_P2_Crop$COG))
b = setdiff(DA_COG_MGS_Crop$COG,DA_COG_P2_Crop$COG)
c = setdiff(DA_COG_P2_Crop$COG,DA_COG_MGS_Crop$COG)
DA_COG_Grass = unique(intersect(DA_COG_MGS_Grass$COG,DA_COG_P2_Grass$COG))
```
...
```
```{r}
overlapping_COG = intersect(rownames(count_COG_MGS), rownames(count_COG_P2))
count_COG_MGS = count_COG_MGS[overlapping_COG,]
count_COG_P2 = count_COG_P2[overlapping_COG,]
rm(overlapping_COG)
```
...
```{r}
count_COG_MGS = count_COG_MGS[count_COG_MGS$sample %in% c("C1-C-T0", "C3-C-T0", "C5-C-T0","P1-C-T6", "P3-C-T6", "P5-C-T6"),]
...
for (samp in c ("C1-C-T0", "C3-C-T0", "C5-C-T0","P1-C-T6", "P3-C-T6", "P5-C-T6")){
...
```{r}
count_COG_P2 = count_COG_P2[count_COG_P2$sample %in% c("C1-C-T0", "C3-C-T0", "C5-C-T0","P1-C-T6", "P3-C-T6", "P5-C-T6"),]
...
scales <- list(scale_x_discrete(labels=c("C1.C.T0", "C3.C.T0", "C5.C.T0")),
               scale_x_discrete(labels=c("P1-C-T6", "P3-C-T6", "P5-C-T6")),
...
ggplot(data=test_data_df, aes(x=sample, y=per_counts, fill=COG_anno)) + 
