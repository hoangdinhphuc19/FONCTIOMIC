...
```{r}
DA_COG_MGS = unique(intersect(DA_COG_MGS_Crop$COG_number,DA_COG_MGS_Grass$COG_number))
DA_COG_P2 = unique(intersect(DA_COG_P2_Crop$COG_number,DA_COG_P2_Grass$COG_number))
```
...
ggplot(data=data_df, aes(x=sample, y=COG_counts, fill=COG_anno)) + 
