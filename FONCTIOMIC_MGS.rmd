...
vect_colours = c("Amended Cropland"="#fbbb3f", "Control Cropland"="#f2e0bd", 
                "Amended Grassland"="#2abf2a", "Control Grassland"="#b2d9b2")
list_colors = list(Groups = vect_colours, Time = time_colors)
ha = rowAnnotation(COG_letter = anno_row$COG_letter,
                   col = list(COG_letter = c(J = "#FCCCFC", A = "#FCDCFC", K = "#FCDCEC", L = "#FCDCDC", 
B = "#FCDCCC", D = "#FCFCCC", Y = "#FCFCBC", V = "#FCFCAC", T = "#ECFCAC", 
M = "#DCFCAC", N = "#CCFCAC", Z = "#BCFCAC", W = "#ACFCAC", U = "#9CFCAC", 
O = "#9CFC9C", X = "#A2AAF6", C = "#BCFCFC", G = "#CCFCFC", E = "#DCFCFC", 
F = "#DCECFC", H = "#DCDCFC", I = "#DCCCFC", P = "#CCCCFC", Q = "#BCCCFC", 
R = "#E0E0E0", S = "#CCCCCC")))
pheatmap(zscore_COG, name = "Z-score",
