...
p2_EC_0 = p2_EC[,rownames(meta_0)]
p2_EC_0 = round(p2_EC_0,0)
dds_P2 = DESeqDataSetFromMatrix(countData =p2_EC_0,
                                  colData = meta_0,
                                  design = ~ groups, tidy = FALSE)
DAA_EC_P2 = DESeq(dds_P2, parallel = TRUE)
dds_P2_vst = vst(dds_P2,blind = FALSE)
```
Results of DESeq2
```{r}
res_EC = results(DAA_EC_P2, parallel = TRUE, contrast = c("groups",
"Control Cropland",
"Control Grassland"))
head(res_EC)
summary(res_EC)
...
```{r}
P2_CC_0 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "control" & meta_cleaned$time == "0",]))
P2_amended_0 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "residues" & meta_cleaned$time == "0",]))
P2_control_3 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "control" & meta_cleaned$time == "3",]))
P2_amended_3 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "residues" & meta_cleaned$time == "3",]))
P2_control_51 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "control" & meta_cleaned$time == "51",])) 
P2_amended_51 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "residues" & meta_cleaned$time == "51",]))
P2_control_125 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "control" & meta_cleaned$time == "125",]))
P2_amended_125 = str_sort(rownames(meta_cleaned[meta_cleaned$modality == "residues" & meta_cleaned$time == "125",]))
```
Subset matrix of EC en fonction of time and traitement
```{r}
P2_mat_control_0 = p2_EC[,P2_control_0]
P2_mat_amended_0 = p2_EC[,P2_amended_0]
P2_mat_control_3 = p2_EC[,P2_control_3]
P2_mat_amended_3 = p2_EC[,P2_amended_3]
P2_mat_control_51 = p2_EC[,P2_control_51]
P2_mat_amended_51 = p2_EC[,P2_amended_51]
P2_mat_control_125 = p2_EC[,P2_control_125]
P2_mat_amended_125 = p2_EC[,P2_amended_125]
```
Calcul de différence entre les matrices
```{r}
P2_dif_0 = P2_mat_control_0 - P2_mat_amended_0
P2_dif_3 = P2_mat_control_3 - P2_mat_amended_3
P2_dif_51 = P2_mat_control_51 - P2_mat_amended_51
P2_dif_125 = P2_mat_control_125 - P2_mat_amended_125
```
