...
count_COG_P2 = assay(vst_COG_P2)[DA_COG,]
...
#cut into arbitrary clusters
cutree_cog = cutree(tree_cog, k = 16)
table(cutree_cog)
```
Heatmap for COG
```{r}
...
"R:[General function prediction only]" = "#d6aadf", "S:[Function unknown]" = "#FFFFFF")),
                    Cluster = anno_block(gp = gpar(fill = c("1" = "#8DD3C7", "2" = "#FFFFB3", "3" = "#BEBADA", 
                                            ...
                                            "16" = "#984EA3", "17" = "#FF7F00", "18" = "#FFFF33")),labels = c(1:16), labels_gp = gpar(fontsize = 8)))
...
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 3,"cluster"] = "0.9"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 4,"cluster"] = "0.3"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 5,"cluster"] = "0.7"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 6,"cluster"] = "1.0"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 7,"cluster"] = "0.5"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 8,"cluster"] = "0.4"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 9,"cluster"] = "1.3"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 10,"cluster"] = "0.8"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 11,"cluster"] = "1.1"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 12,"cluster"] = "1.2"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 13,"cluster"] = "0.6"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 14,"cluster"] = "1.6"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 15,"cluster"] = "1.5"
COG_DA_a_vs_c[COG_DA_a_vs_c$cluster == 16,"cluster"] = "1.4"
...
```{r}
df_count_COG_P2 = as.data.frame(p2_COG[DA_COG,rownames(meta_cleaned)])
...
```{r}
plot_grid = list()
  for (i in c(1,5,9,13,17,21,25,29,33,37,41,45,49,53,57,61)){
