...
Data transformation
```{r}
p2_EC_clr = clr(p2_EC_cleaned)
p2_EC_clr = na.omit(p2_EC_clr)
```
Distance between the variables (intergroups, Control vs Amended)
```{r}
dist_a_vs_c = vegan::vegdist(t(p2_EC_clr), method = "euclidean")
...
```{r}
dist_ec = vegan::vegdist(p2_EC_clr, method = "euclidean")
