...
p2_COG = as.data.frame(p2_COG)
  ...
  p2_COG = p2_COG[,-1]
p2_pathways = read_delim("Data FONCTIOMIC/picrust2out_ver2/pathways_out/path_abun_unstrat.tsv.gz",delim = "\t",col_names = TRUE)
p2_pathways = as.data.frame(p2_pathways)
  rownames(p2_pathways) = p2_pathways[,1]
  p2_pathways = p2_pathways[,-1]
```
